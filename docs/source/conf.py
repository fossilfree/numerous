...
sys.path.insert(0, os.path.abspath('../..'))
sys.path.insert(0, os.path.abspath('../../..'))
sys.path.insert(0, os.path.abspath('../../numerous/engine'))
sys.path.insert(0, os.path.abspath('../../numerous/engine/model'))
sys.path.insert(0, os.path.abspath('../../numerous/engine/simulation'))
sys.path.insert(0, os.path.abspath('../../numerous/engine/system'))
sys.path.insert(0, os.path.abspath('../../numerous/utils'))
...
latex_documents = [
    (master_doc, 'Numerous.tex', 'Numerous Documentation',
     'FossilFree', 'manual'),
]
...
man_pages = [
    (master_doc, 'numerous', 'Numerous Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Numerous', 'Numerous Documentation',
     author, 'Numerous', 'One line description of project.',
     'Miscellaneous'),
]
