...
def test_llvm_1_to_1_mapping_state():
    ...
    llvm_program.add_mapping([("oscillator1.mechanics.x", IS_GLOBAL_VAR)], [("oscillator1.mechanics.x_dot", IS_GLOBAL_VAR)])
...
def test_llvm_1_to_n_mapping():
    ...
    llvm_program.add_mapping([("oscillator1.mechanics.x", IS_GLOBAL_VAR)],
                             [("oscillator1.mechanics.x_dot", IS_GLOBAL_VAR), ("oscillator1.mechanics.y_dot", IS_GLOBAL_VAR)])
...
def test_llvm_nested_function_and_mapping():
    ...
    llvm_program.add_call(llvm_names[eval_llvm2.__qualname__],
                          [("oscillator1.mechanics.x", IS_GLOBAL_VAR), ("oscillator1.mechanics.y", IS_GLOBAL_VAR),
                           ("oscillator1.mechanics.a", IS_GLOBAL_VAR), ("oscillator1.mechanics.y_dot", IS_GLOBAL_VAR)], target_ids=[2, 3])
...
def test_llvm_1_function_and_mappings():
    ...
    llvm_program.add_call(llvm_names[eval_llvm.__qualname__], [("oscillator1.mechanics.b", IS_GLOBAL_VAR), ("oscillator1.mechanics.y", IS_GLOBAL_VAR),
...
def test_llvm_loop_seq():
    ...
    llvm_program.add_set_call(llvm_names[eval_llvm.__qualname__], [
        [("oscillator1.mechanics.y", IS_GLOBAL_VAR), ("oscillator1.mechanics.z", IS_GLOBAL_VAR),
    ("oscillator1.mechanics.a", IS_GLOBAL_VAR), ("oscillator1.mechanics.b", IS_GLOBAL_VAR)],
        [("oscillator1.mechanics.c", IS_GLOBAL_VAR), ("oscillator1.mechanics.x_dot", IS_GLOBAL_VAR),
         ("oscillator1.mechanics.y_dot", IS_GLOBAL_VAR),
         ("oscillator1.mechanics.z_dot", IS_GLOBAL_VAR)]],
                              targets_ids=[2, 3])
